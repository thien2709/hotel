    ...
    return (
        <>
            <Container className='mb-2'>
                <Header tiltle={"Our Services"} />
                <Row>
                    <h4 className='text-center'>
                        Services at <span className='hotel-color'>Mini - </span> Hotel
                    ...
                    <Col>
                        <Card>
                            <Card.Body>
                                ...
                                <Card.Text>
                                    Park your car convenienty in our on-site parking lot.
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
